...
class Ui_FlightSearchWindow(object):
    def setupUi(self, FlightSearchWindow):
        ...
        self.startbox = QtWidgets.QComboBox(self.centralwidget)
        self.startbox.setObjectName("startbox")
        self.searchLayout.addWidget(self.startbox)
        ...
        self.searchLayout.addWidget(self.destinationbox)
        self.searchButtonDir = QtWidgets.QPushButton(self.centralwidget)
        self.searchButtonDir.setCursor(QtGui.QCursor(QtCore.Qt.PointingHandCursor))
...
"}"))
        ...
        self.statuslabel.setText(_translate("FlightSearchWindow", "<html><head/><body><p><br/></p></body></html>"))
